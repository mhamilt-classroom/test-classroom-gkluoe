...
/*! 
 ...
 @abstract Specifies the receiverÕs background layer.
 */
- (void) setBackgroundLayer:(CALayer *) aLayer;

/*! 
 @method backgroundLayer
 @abstract Provides the receiverÕs background layer.
 */
...
/*! 
 ...
 @abstract Specifies the receiverÕs foreground layer.
 */
- (void) setForegroundLayer:(CALayer *) aLayer;

/*! 
 @method foregroundLayer
 @abstract Provides the receiverÕs foreground layer.
 */
...
/*!
  @method setContentResizingMask
  @abtract Returns the receiverÕs content resizing mask, which determines how itÕs content is resized while zooming.
*/
...
/*! 
 ...
 @param aSize The vertical and horizontal spacing to use between cells in the receiver. By default, both values are 10.0 in the receiverÕs coordinate system.
 */
...
/*! 
 ...
 @abstract Returns indexes of the receiverÕs currently visible items.
 */
...
/*! 
 ...
 @abstract Returns the indexes of the receiverÕs rows that intersect the specified rectangle.
 */
- (NSIndexSet *) rowIndexesInRect:(NSRect) rect;

/*! 
 @method columnIndexesInRect:
 @abstract Returns the indexes of the receiverÕs columns that intersect the specified rectangle.
 */
