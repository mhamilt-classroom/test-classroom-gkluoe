...
/*!
	...
	@abstract		The display name of a QTMovie object.
					A display name is stored as user data in a movie file and hence may differ from the base name of the movieÕs filename or URL.
...
/*!
	...
	@abstract		Creates a QTMovie object initialized with the data from the movie having the specified name in the applicationÕs bundle.
	@param			errorPtr
					A pointer to an NSError object; if a movie cannot be created, an NSError object is returned in this location.
	@result			A QTMovie object.
*/
